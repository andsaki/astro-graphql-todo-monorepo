...
type ComplexityRoot struct {
	Mutation struct {
		...
		UpdateTodo func(childComplexity int, id string, completed bool) int
	}
...
type MutationResolver interface {
	...
	UpdateTodo(ctx context.Context, id string, completed bool) (*model.Todo, error)
...
func (e *executableSchema) Complexity(ctx context.Context, typeName, field string, childComplexity int, rawArgs map[string]any) (int, bool) {
	...
	case "Mutation.updateTodo":
		...
		return e.complexity.Mutation.UpdateTodo(childComplexity, args["id"].(string), args["completed"].(bool)), true
...
func (ec *executionContext) field_Query_todos_args(ctx context.Context, rawArgs map[string]any) (map[string]any, error) {
	var err error
	args := map[string]any{}
	arg0, err := graphql.ProcessArgField(ctx, rawArgs, "term", ec.unmarshalOString2ᚖstring)
	if err != nil {
		return nil, err
	}
	args["term"] = arg0
...
func (ec *executionContext) _Mutation_updateTodo(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (any, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Mutation().UpdateTodo(rctx, fc.Args["id"].(string), fc.Args["completed"].(bool))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
